...
class ProcessTest extends TestCase
{
	...
	public function dataForTestCleanupTimeout(): \Generator
	{
		yield from [
			...
			"invalidAnonymousClass" => [new class() { function __toInt() { return 30;}}, TypeError::class,],
		];
	...
	public function dataForTestConstructor(): array
	{
		return [
			...
			"typicalRootPwdOutputNotifier" => ["/usr/bin/echo", [], "/", function(){},],
			"typicalRootPwdOutputNotifierWithArgs" => ["/usr/bin/echo", ["'foo'", "'bar'",], "/", function(){},],
			"typicalRootPwdErrorNotifier" => ["/usr/bin/echo", [], "/", null, function(){},],
			"typicalRootPwdErrorNotifierWithArgs" => ["/usr/bin/echo",  ["'foo'", "'bar'",], "/", null, function(){},],
			"extremeEmptyCommand" => ["", [], "/",],
			...
			"invalidStringableAnonymousClassCommand" => [new class() { public function __toString(): string { return "/usr/bin/echo"; }}, [], null, null, null, TypeError::class,],
			"invalidStringableStdClassCommand" => [(object) ["__toString" => function() { return "/usr/bin/echo"; },], [], null, null, null, TypeError::class,],
			"invalidArrayCommand" => [["__toString" => function() { return "/usr/bin/echo"; },], [], null, null, null, TypeError::class,],
			...
			"invalidArgsArrayWithOnlyInvalidElements" => ["/usr/bin/echo", [null, new class() {public function __toString(): string { return "'foo'"; }},], null, null, null, \InvalidArgumentException::class,],

			"invalidArrayableAnonymousClassArgs" => ["/usr/bin/echo", new class() { public function __toArray(): array { return ["'foo'"]; }}, null, null, null, TypeError::class,],
			"invalidArrayableStdClassArgs" => ["/usr/bin/echo", (object) ["__toArray" => function() { return ["'foo'"]; },], null, null, null, TypeError::class,],
			...
			"invalidStringableAnonymousClassPwd" => ["/usr/bin/echo", [], new class() { public function __toString(): string { return "/"; }}, null, null, TypeError::class,],
			"invalidStringableStdClassPwd" => ["/usr/bin/echo", [], (object) ["__toString" => function() { return "/"; },], null, null, TypeError::class,],
			"invalidArrayPwd" => ["/usr/bin/echo", [], ["__toString" => function() { return "/"; },], null, null, TypeError::class,],
			"invalidIntPwd" => ["/usr/bin/echo", [], 12, null, null, TypeError::class,],
			"invalidFloatPwd" => ["/usr/bin/echo", [], 29.456, null, null, TypeError::class,],

			"invalidInvokableOutputHandler" => ["/usr/bin/echo", [], "/", new class() {public function __invoke(): void {}}, null, TypeError::class,],
			"invalidInvokableErrorHandler" => ["/usr/bin/echo", [], "/", null, new class() {public function __invoke(): void {}}, TypeError::class,],
			"invalidInvokableOutputAndErrorHandler" => ["/usr/bin/echo", [], "/", new class() {public function __invoke(): void {}},  new class() {public function __invoke(): void {}}, TypeError::class,],
		];
	}
	...
	public function dataForTestSetCommand(): array
	{
		return [
			...
			"invalidStringableAnonymousClass" => [new class() { public function __toString(): string { return "/usr/bin/echo"; }}, TypeError::class,],
			"invalidStringableStdClass" => [(object) ["__toString" => function() { return "/usr/bin/echo"; },], TypeError::class,],
			"invalidArray" => [["__toString" => function() { return "/usr/bin/echo"; },], TypeError::class,],
	...
	public function dataForTestSetArguments(): array
	{
		return [
			...
			"invalidOnlyInvalidElements" => [[null, new class() {public function __toString(): string { return "'foo'"; }},], \InvalidArgumentException::class,],

			"invalidArrayableAnonymousClass" => [new class() { public function __toArray(): array { return ["'foo'"]; }}, TypeError::class,],
			"invalidArrayableStdClass" => [(object) ["__toArray" => function() { return ["'foo'"]; },], TypeError::class,],
	...
	public function dataForTestSetWorkingDirectory(): array
	{
		return [
			...
			"invalidStringableAnonymousClass" => [new class() { public function __toString(): string { return "/"; }}, TypeError::class,],
			"invalidStringableStdClass" => [(object) ["__toString" => function() { return "/"; },], TypeError::class,],
			"invalidArray" => [["__toString" => function() { return "/"; },], TypeError::class,],
			"invalidInt" => [12, TypeError::class,],
			"invalidFloat" => [29.456, TypeError::class,],
		];
	}
	...
	public function dataForTestSetEnvironment(): array
	{
		return [
			...
			"invalidStringableAnonymousClassValue" => [["foo" => new class() { public function __toString(): string { return "bar"; }},], InvalidArgumentException::class,],
			"invalidStringableObjectValue" => [["foo" => (object) ["__toString" => function(): string { return "bar";},]], InvalidArgumentException::class,],

			"invalidOneInvalidElement" => [["foo" => "bar", "baz" => null,], InvalidArgumentException::class,],
			"invalidAllInvalidElements" => [["foo" => null, "bar" => new class() {public function __toString(): string { return "'foo'"; }},], \InvalidArgumentException::class,],

			"invalidArrayableAnonymousClass" => [new class() { public function __toArray(): array { return ["foo" => "bar"]; }}, TypeError::class,],
			"invalidArrayableStdClass" => [(object) ["__toArray" => function() { return ["foo" => "bar"]; },], TypeError::class,],
			"invalidString" => ["foo", TypeError::class,],
			"invalidInt" => [12, TypeError::class,],
			"invalidFloat" => [29.456, TypeError::class,],
		];
