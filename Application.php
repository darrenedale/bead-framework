...
//		 *
//		 * Because translated strings may need to contain variable content - i.e. have the name of something inserted
//		 * into them - and because the order of the inserted content in the string may vary between languages, indexed
...
//		 *
//		 */
//		public static function tr(string $string, string $file = null, int $line = null, ... $args): string {
