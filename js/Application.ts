namespace Equit {
    ...
    interface ToastCustomButtonFunction {
        (): void;
    }

    interface ToastCustomButton {
    ...
    export class Application {
        ...
        static readonly DefaultToastTimeout: number = 2500;
        static readonly NewWindowFlag: number = 0x01;
         ...
         */
        public static doApiCall(action: string, parameters: object = null, data: object = null, options) {
     ...
     *
     * All API responses are thus:
     *     {code}[ {optional_code_message}]
     *     {data}
     *
     * The {code} is 0 on success, something else on failure.
     * The {optional_code_message} is usually set to something useful to tell the end user in case of failure. On
     * success it is often omitted.
     * The {data} contains the data returned by the API function. The content of this varies according to the function
     * called. This is commonly JSON structured data.
     */
