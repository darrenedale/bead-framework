...
class EmailPart {
	...
	/** @var array[EmailHeader] The part's headers. */
	protected $m_headers = [];
	 ...
	 *
	 * @param $content string _optional_ The content.
	 * @param $contentType string _optional_ The content type for the message part.
	 * @param $contentEncoding string _optional_ The content encoding.
	 */
	 ...
	 */
	public function addHeader($header, string $value = "") {
		...
		AppLog::error("received invalid \$header argument: " . stringify($header), E_USER_ERROR);
