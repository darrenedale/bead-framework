...
class LegacyRequest
{
    ...
    /** @var LegacyRequest|null The request parsed from the superglobals. */
    private static ?LegacyRequest $s_originalRequest = null;
    ...
    /** @var array<string,LegacyUploadedFile> The files uploaded with the request. */
     ...
     *
     * @return LegacyUploadedFile|null The requested file, or `null` if the file does not exist.
     */
    public function uploadedFile(string $identifier): ?LegacyUploadedFile
    {
     ...
     * @param $file LegacyUploadedFile The file to set.
     *
     ...
     */
    public function setUploadedFile(string $identifier, ?LegacyUploadedFile $file): void
    {
        $identifier = mb_strtolower($identifier, "UTF-8");
     ...
     * be "/baz".
     *
     * @return LegacyRequest The original request submitted to the server.
     */
    public static function originalRequest(): LegacyRequest
    {
        if (is_null(LegacyRequest::$s_originalRequest)) {
            $req = new LegacyRequest();
            ...
            $req->m_files = LegacyUploadedFile::allUploadedFiles();
            ...
            LegacyRequest::$s_originalRequest = $req;
        }

        return LegacyRequest::$s_originalRequest;
    }
}
