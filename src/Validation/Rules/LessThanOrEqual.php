...
/**
 * Validation rule that ensures a value is less than or equal to the value in another field in the dataset.
 *
 ...
 *
 * - if the data is an int, or can be coerced to an int, it must be less than or equal to the int value in the referenced field.
 * - if the data is aa float, or can be coerced to a float, it must be less than or equal to the float value in the referenced
 *   field.
 ...
 */
class LessThanOrEqual extends FieldComparingRule
{
    /**
    ...
    {
        return tr("The %1 field must be less than or equal to the value in the %2 field.", __FILE__, __LINE__, $field, $this->otherField());
    }
}
