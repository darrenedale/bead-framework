...
class InvalidPluginException extends Exception
{
	...
	/** @var \Equit\GenericPlugin|null The plugin instance, if available. */
	private ?GenericPlugin $m_plugin;

	/**
	 * @param string $path The path from which the plugin was attempted to be loaded.
	 * @param \Equit\GenericPlugin|null $plugin The plugin instance, if available.
	 ...
	 */
	public function __construct(string $path, ?GenericPlugin $plugin = null, string $message = "", int $code = 0, Throwable $previous = null)
	{
	 ...
	 *
	 * @return \Equit\GenericPlugin|null The plugin.
	 */
	public function getPlugin(): ?GenericPlugin
	{
